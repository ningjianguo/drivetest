...
public class ExamQuestion1  implements java.io.Serializable {
	...
	private static final long serialVersionUID = 2250653590618361658L;
	private String question1Id;
     private Integer question1No;
	...
	/** minimal constructor */
    public ExamQuestion1(String question1Id, Integer question1No, String question1Question, String question1Answer, String question1Item1, String question1Item2, String question1Explains) {
        this.question1Id = question1Id;
        this.question1No = question1No;
    ...
    /** full constructor */
    public ExamQuestion1(String question1Id, Integer question1No, String question1Question, String question1Answer, String question1Item1, String question1Item2, String question1Item3, String question1Item4, String question1Explains, String question1Url, Set examPaper1s) {
        this.question1Id = question1Id;
        this.question1No = question1No;
        this.question1Question = question1Question;
        this.question1Answer = question1Answer;
    ...
    public Integer getQuestion1No() {
        return this.question1No;
    }
    
    public void setQuestion1No(Integer question1No) {
        this.question1No = question1No;
    }
